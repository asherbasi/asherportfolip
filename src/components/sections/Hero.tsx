...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-4 py-20 lg:grid-cols-2 lg:px-8">
        <AnimatedSection>
        ...
        <AnimatedSection delay={200} className="flex justify-center lg:justify-end">
          <div className="relative">
            ...
            <img
              ...
              width={1024}
              height={1024}
              className="relative h-72 w-72 rounded-full border-4 border-white object-cover shadow-2xl shadow-black/10 md:h-96 md:w-96"
            />
          </div>
        </AnimatedSection>
      </div>
